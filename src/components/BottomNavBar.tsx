...
export function BottomNavBar({ tabs, activeTab, setActiveTab }: BottomNavBarProps) {
  return (
    <nav className="sticky bottom-0 z-40 bg-white/95 dark:bg-gray-900/95 backdrop-blur-lg border-t border-gray-200 dark:border-gray-800 shadow-lg pb-[max(var(--safe-area-inset-bottom),8px)]">
            ...
            return (
              <motion.button
                ...
                className={`
                  ...
                  transition-all duration-300 flex-1 min-w-0 min-h-[56px]
                  ${isActive 
