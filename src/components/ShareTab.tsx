...
import { Send, Loader2, Crown, Sparkles, Shield, Info, Lightbulb, User, Eye, EyeOff, AlertTriangle, Filter, X } from 'lucide-react';
...
import { createPost, canPost, incrementPostCount, getSubscription } from '../utils/api';
...
export function ShareTab() {
  ...
  const categories = [
    { name: 'General', emoji: '💬', color: 'purple' },
    { name: 'Controversial', emoji: '🔥', color: 'orange', hot: true },
    { name: 'Clickbait', emoji: '💣', color: 'orange', hot: true },
    { name: 'Exposed', emoji: '🚨', color: 'orange', hot: true },
    { name: 'Heartbreak', emoji: '💔', color: 'pink' },
    { name: 'Shocking', emoji: '😱', color: 'orange', hot: true },
    { name: 'Confessions', emoji: '🤯', color: 'orange', hot: true },
    { name: 'Dark Secrets', emoji: '💀', color: 'orange', hot: true },
    { name: 'Drama', emoji: '🎭', color: 'orange', hot: true },
    { name: 'Tea & Gossip', emoji: '👀', color: 'orange', hot: true },
    { name: 'Money Problems', emoji: '💸', color: 'yellow' },
    { name: 'NSFW Stories', emoji: '🔞', color: 'orange', hot: true },
    { name: 'Unpopular Opinions', emoji: '⚠️', color: 'orange', hot: true },
    { name: 'Addictions', emoji: '❤️‍🩹', color: 'red' },
    { name: 'Mental Health', emoji: '🧠', color: 'blue' },
    { name: 'Relationships', emoji: '💗', color: 'pink' },
    { name: 'Career', emoji: '💼', color: 'indigo' },
    { name: 'Family', emoji: '🏠', color: 'green' },
    { name: 'Education', emoji: '🎓', color: 'blue' },
    { name: 'Self-Care', emoji: '💪', color: 'green' },
    { name: 'Personal Growth', emoji: '🌟', color: 'yellow' },
    { name: 'Anxiety', emoji: '😔', color: 'gray' },
    { name: 'Depression', emoji: '💭', color: 'gray' },
    { name: 'Friendships', emoji: '🤝', color: 'teal' },
    { name: 'Motivation', emoji: '✨', color: 'yellow' },
    { name: 'Random', emoji: '🎲', color: 'purple' },
  ];
          ...
          toast.error(
            t('share.limitReached'),
            {
              ...
              action: {
                ...
                onClick: async () => {
                  // Try native paywall first, fallback to modal
                  try {
                    await showPaywall({
                      onPurchaseSuccess: () => {
                        loadLimits();
