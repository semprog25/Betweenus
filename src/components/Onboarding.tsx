...
import { Heart, Shield, Globe, Sparkles, ArrowRight, Check, Award } from 'lucide-react';
import { useLanguage, LANGUAGES } from './LanguageContext';
import { AuthStep } from './AuthStep';
import logoImage from '../assets/5a1aa58d0178d59fddfa201fc0db8049ffe9a884.png';
...
export function Onboarding({ onComplete }: { onComplete: (languages: string[], name?: string) => void }) {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-6 relative overflow-hidden bg-[#0f0f1e]">
      ...
      <AnimatePresence mode="wait">
        ...
        {isInfoStep && (
          ...
          >
            ...
            >
              <div className="text-8xl">
                {ONBOARDING_STEPS[infoStepIndex].emoji}
              </div>
            </motion.div>
