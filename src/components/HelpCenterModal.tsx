  ...
  },
  {
    ...
    articles: [
      ...
      },
      {
        ...
        answer: 'Visit the "Listen & Support" tab to read community posts. You can leave supportive replies, upvote posts, and show that someone is heard. Remember to be kind and follow community guidelines.',
      },
      {
  ...
  },
  {
    ...
    articles: [
      ...
      },
      {
        ...
        answer: '💬 Storyteller (Share 10+ secrets), 🤝 Supportive Friend (Give 25+ replies), ⭐ Community Favorite (Receive 50+ upvotes), 💜 Active Participant (Both share and reply), 🎉 Veteran (30+ days as member). Badges appear on your profile automatically when you meet the requirements. Keep engaging to collect them all!',
      },
      {
  ...
  },
  {
    ...
    articles: [
      ...
      },
      {
        ...
        answer: 'Contact support through "Send Feedback" to request account deletion. All your data will be permanently deleted within 30 days. This action cannot be undone.',
      },
      {
