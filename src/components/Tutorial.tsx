...
import { CheckCircle, Ear, MessageSquarePlus, ArrowRight, X, Award } from 'lucide-react';
...
export function Tutorial({ onComplete }: TutorialProps) {
  ...
  const steps = [
    ...
    {
      title: t('tutorial.listen.title') || 'Listen & Support',
      description: t('tutorial.listen.description') || 'Read anonymous thoughts from the community. Send supportive reactions, leave encouraging comments, and help others feel heard.',
      icon: Ear,
      gradient: 'from-cyan-500 via-blue-500 to-purple-600',
      emoji: '💙',
      features: [
        t('tutorial.listen.feature1') || 'Read community thoughts',
        t('tutorial.listen.feature2') || 'Send warm reactions',
        t('tutorial.listen.feature3') || 'Leave supportive comments',
        t('tutorial.listen.feature4') || 'Filter by mood'
      ]
    },
    {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-black p-6">
      ...
      <button
        onClick={handleSkip}
        className="absolute top-6 right-6 z-10 p-2 rounded-full bg-gray-200/50 dark:bg-gray-800/50 hover:bg-gray-300/50 dark:hover:bg-gray-700/50 transition-colors"
      >
      ...
      <div className="relative max-w-lg w-full">
        <AnimatePresence mode="wait">
          ...
          >
            ...
            {/* Title */}
            <h2 className="mb-4 text-gray-900 dark:text-white flex items-center gap-3">
